  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-orange-100 overflow-hidden">
      <div className="max-w-5xl mx-auto z-10 px-6 py-12 text-gray-800 ">
        <p className="text-orange-600 uppercase tracking-wide text-sm md:text-base font-semibold text-left md:text-center">
          Plan Your Destination
        </p>
        <h2 className="text-5xl md:text-5xl font-bold mb-4 text-orange-800 text-left md:text-center">
